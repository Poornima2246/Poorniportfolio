        ...
        <div className="relative mt-20 mb-4">
          ...
          <div className="absolute flex top-20 sm:top-32 md:top-40 lg:top-64 left-5 sm:left-14">
            ...
            >
              ...
              {/* <a href="mailto:poornima220500@gmail.com"><button class="border-purple-500 border-2 mt-4 w-20 md:w-28 p-2 rounded-xl bg-transparent hover:bg-purple-700 transition-all ease-in-out duration-500 font-extralight" >Contact</button></a> */}
              
              {/* <a  href="tel:+917010039610">
             <button className="border-purple-500 border-2 mt-4 w-20 md:w-28 p-2 rounded-xl bg-transparent hover:bg-purple-700 transition-all ease-in-out duration-500 font-extralight">
              ...
              {/* <a href="mailto:poornima220500@gmail.com"> <button className="border-purple-500 border-2 mt-4 w-20 md:w-28 p-2 rounded-xl bg-transparent hover:bg-purple-700 transition-all ease-in-out duration-500 font-extralight">
               Email
             </button></a>
              */}
